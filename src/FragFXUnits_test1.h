...
//  postFxVJ
//
//  Created by Ovis aries on 2015/05/12.
//
//

#ifndef postFxVJ_FragFXUnits_test1_h
#define postFxVJ_FragFXUnits_test1_h

#include "ofxKsmrFragFXUnit.h"

class FragFXUnits_test1 : public ofxKsmrFragFXUnit{
